...
QKeyEvent toto = QKeyEvent(QEvent::KeyPress, JoystickKey::Button_X, 0);
...
int main(int argc, char *argv[])
{
    ...
    MyQQuickView viewer(QString("C:/Users/Paul/Music/downloadhelper/Keepit"));
